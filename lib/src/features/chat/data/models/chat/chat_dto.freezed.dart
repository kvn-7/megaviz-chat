...
mixin _$ChatUserDto {
 ...
 String get uid; String get displayName; String? get photoURL; bool get isOnline;@TimestampConverter() DateTime? get lastSeen; String? get fcmToken;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,uid,displayName,photoURL,isOnline,lastSeen,fcmToken);

@override
String toString() {
  return 'ChatUserDto(uid: $uid, displayName: $displayName, photoURL: $photoURL, isOnline: $isOnline, lastSeen: $lastSeen, fcmToken: $fcmToken)';
}
...
@useResult
$Res call({
 String uid, String displayName, String? photoURL, bool isOnline,@TimestampConverter() DateTime? lastSeen, String? fcmToken
});
...
/// Create a copy of ChatUserDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uid = null,Object? displayName = null,Object? photoURL = freezed,Object? isOnline = null,Object? lastSeen = freezed,Object? fcmToken = freezed,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String uid,  String displayName,  String? photoURL,  bool isOnline, @TimestampConverter()  DateTime? lastSeen,  String? fcmToken)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChatUserDto() when $default != null:
return $default(_that.uid,_that.displayName,_that.photoURL,_that.isOnline,_that.lastSeen,_that.fcmToken);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String uid,  String displayName,  String? photoURL,  bool isOnline, @TimestampConverter()  DateTime? lastSeen,  String? fcmToken)  $default,) {final _that = this;
switch (_that) {
case _ChatUserDto():
return $default(_that.uid,_that.displayName,_that.photoURL,_that.isOnline,_that.lastSeen,_that.fcmToken);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String uid,  String displayName,  String? photoURL,  bool isOnline, @TimestampConverter()  DateTime? lastSeen,  String? fcmToken)?  $default,) {final _that = this;
switch (_that) {
case _ChatUserDto() when $default != null:
return $default(_that.uid,_that.displayName,_that.photoURL,_that.isOnline,_that.lastSeen,_that.fcmToken);case _:
  return null;
...
class _ChatUserDto implements ChatUserDto {
  const _ChatUserDto({required this.uid, required this.displayName, this.photoURL, this.isOnline = false, @TimestampConverter() this.lastSeen, this.fcmToken});
...
/// Create a copy of ChatUserDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? uid = null,Object? displayName = null,Object? photoURL = freezed,Object? isOnline = null,Object? lastSeen = freezed,Object? fcmToken = freezed,}) {
...
mixin _$ChatMessageDto {
 ...
 String get id; String get chatId; ChatMessageContentDto get content;@TimestampConverter() DateTime get timestamp; String get senderId; bool get isRead;
...
@override
String toString() {
  return 'ChatMessageDto(id: $id, chatId: $chatId, content: $content, timestamp: $timestamp, senderId: $senderId, isRead: $isRead)';
}
...
@useResult
$Res call({
 String id, String chatId, ChatMessageContentDto content,@TimestampConverter() DateTime timestamp, String senderId, bool isRead
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String chatId,  ChatMessageContentDto content, @TimestampConverter()  DateTime timestamp,  String senderId,  bool isRead)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChatMessageDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String chatId,  ChatMessageContentDto content, @TimestampConverter()  DateTime timestamp,  String senderId,  bool isRead)  $default,) {final _that = this;
switch (_that) {
case _ChatMessageDto():
return $default(_that.id,_that.chatId,_that.content,_that.timestamp,_that.senderId,_that.isRead);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String chatId,  ChatMessageContentDto content, @TimestampConverter()  DateTime timestamp,  String senderId,  bool isRead)?  $default,) {final _that = this;
switch (_that) {
case _ChatMessageDto() when $default != null:
return $default(_that.id,_that.chatId,_that.content,_that.timestamp,_that.senderId,_that.isRead);case _:
  return null;
...
class _ChatMessageDto implements ChatMessageDto {
  const _ChatMessageDto({required this.id, required this.chatId, required this.content, @TimestampConverter() required this.timestamp, required this.senderId, this.isRead = false});
...
mixin _$SendMessageDto {
 ...
 String get chatId; ChatMessageContentDto get content;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SendMessageDto&&(identical(other.chatId, chatId) || other.chatId == chatId)&&(identical(other.content, content) || other.content == content));
}
...
@override
String toString() {
  return 'SendMessageDto(chatId: $chatId, content: $content)';
}
...
@useResult
$Res call({
 String chatId, ChatMessageContentDto content
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String chatId,  ChatMessageContentDto content)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SendMessageDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String chatId,  ChatMessageContentDto content)  $default,) {final _that = this;
switch (_that) {
case _SendMessageDto():
return $default(_that.chatId,_that.content);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String chatId,  ChatMessageContentDto content)?  $default,) {final _that = this;
switch (_that) {
case _SendMessageDto() when $default != null:
return $default(_that.chatId,_that.content);case _:
  return null;
...
class _SendMessageDto implements SendMessageDto {
  const _SendMessageDto({required this.chatId, required this.content});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SendMessageDto&&(identical(other.chatId, chatId) || other.chatId == chatId)&&(identical(other.content, content) || other.content == content));
}
