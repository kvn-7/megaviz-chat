const List<Map<String, String>> countryCodes = [
  {
    'name': 'دولة الإمارات العربية المتحدة (UAE)',
    'code': 'AE',
    'dial_code': '+971',
  },
  {
  ...
  {'name': 'الكويت (Kuwait)', 'code': 'KW', 'dial_code': '+965'},
  {'name': 'قطر (Qatar)', 'code': 'QA', 'dial_code': '+974'},
  {'name': '‏البحرين (Bahrain)', 'code': 'BH', 'dial_code': '+973'},
  {'name': 'عمان (Oman)', 'code': 'OM', 'dial_code': '+968'},
...
String? getCountryCodeFromDialCode(String code) {
  for (var i = 0; i < countryCodes.length; i++) {
    if (countryCodes[i]['dial_code'] == code) {
...
(String, String) getCountryCodeDetails(String code) {
  for (var i = 0; i < countryCodes.length; i++) {
    if (countryCodes[i]['code'] == code) {
      return (countryCodes[i]['name']!, countryCodes[i]['dial_code']!);
    }
  }
  return ('', '');
}

String? getCountryCodeFromCountryName(String name) {
  for (var i = 0; i < countryCodes.length; i++) {
    if (countryCodes[i]['name'] == name) {
      return countryCodes[i]['code'];
    }
  }
  return null;
